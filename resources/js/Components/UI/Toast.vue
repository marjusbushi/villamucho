...
<template>
    ...
    >
        <div
            v-if="visible"
            :class="[
                'flex items-center gap-3 rounded-lg px-4 py-3 text-white shadow-dropdown',
        ...
        >
            ...
            <p class="text-body-sm font-medium flex-1">{{ message }}</p>
            <button
                class="shrink-0 rounded-md p-0.5 hover:bg-white/20 transition-colors duration-150"
                @click="emit('dismiss')"
            >
