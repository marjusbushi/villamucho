...
const kpis = computed(() => [
    { label: translate('reports360.posControls.netCollected'), value: money(summary.value.net_collected), tone: 'accent', icon: CreditCard, trend: trend(changes.value.net_collected), trendText: changeText('net_collected') },
    { label: translate('reports360.posControls.refunds'), value: money(summary.value.refund_total), tone: 'warning', icon: RotateCcw, trend: trend(changes.value.refund_total), trendText: changeText('refund_total') },
    { label: translate('reports360.posControls.voids'), value: summary.value.void_count || 0, tone: 'error', icon: Ban, detail: money(summary.value.void_value) },
