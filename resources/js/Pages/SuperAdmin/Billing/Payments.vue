...
<template>
    <SuperAdminLayout title="Pagesat — Lora Control Panel">
        <main class="sa-page max-w-[1320px] space-y-4">
            <BillingPageHeader title="Pagesat" subtitle="Pagesat manuale dhe online të platformës.">
