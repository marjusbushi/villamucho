...
class GuestUpdateRequest extends FormRequest
{
    ...
    public function rules(): array
    {
        ...
        return [
            ...
            'email' => ['nullable', 'email', 'max:255', Rule::unique('guests', 'email')->ignore($guestId)->whereNull('deleted_at')],
            'phone' => ['nullable', 'string', 'max:30'],
            'document_type' => ['nullable', 'in:id_card,passport,drivers_license'],
            'document_number' => ['nullable', 'string', 'max:50', Rule::unique('guests', 'document_number')->ignore($guestId)],
